...
//15450619/1315344/2.50/8/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "TMCS1107A1BQDRQ1" (originalName "TMCS1107A1BQDRQ1")
	...
	(compDef "TMCS1107A1BQDRQ1" (originalName "TMCS1107A1BQDRQ1") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		)
		(compPin "1" (pinName "IN+_1") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "2" (pinName "IN+_2") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "3" (pinName "IN-_1") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "4" (pinName "IN-_2") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "8" (pinName "VS") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "TMCS1107A1BQDRQ1"))
		...
		(attr "Manufacturer_Part_Number" "TMCS1107A1BQDRQ1")
		(attr "Mouser Part Number" "595-TMCS1107A1BQDRQ1")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Texas-Instruments/TMCS1107A1BQDRQ1?qs=A6eO%252BMLsxmRDGOpu2d0NVw%3D%3D")
		(attr "Arrow Part Number" "TMCS1107A1BQDRQ1")
		(attr "Arrow Price/Stock" "https://www.arrow.com/en/products/tmcs1107a1bqdrq1/texas-instruments?utm_currency=USD&region=nac")
		(attr "Description" "Board Mount Current Sensors AEC-Q100, +/-420-V isolated Hall-effect current sensor with internal reference 8-SOIC -40 to 125")
		(attr "<Hyperlink>" "https://www.ti.com/lit/ds/symlink/tmcs1107-q1.pdf?ts=1634009705469&ref_url=https%253A%252F%252Fwww.ti.com%252Fsitesearch%252Fdocs%252Funiversalsearch.tsp%253FlangPref%253Den-US%2526searchTerm%253DTMCS1107A4UQDRQ1%2526nr%253D2")
		(attr "<Component Height>" "1.75")
		(attr "<STEP Filename>" "TMCS1107A1BQDRQ1.stp")
